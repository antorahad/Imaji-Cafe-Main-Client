...
const Order = () => {
    ...
    const { name, price, discount } = loadOrder;
        ...
        <div className="max-w-7xl flex items-center justify-center mx-auto py-10 px-5 min-h-screen">
           <div className="flex flex-col gap-7 w-full md:w-2/3 bg-white p-5 border rounded-md">
                ...
                <form onSubmit={handleCofirmOrder} className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                    <input type="text" name="customerName" placeholder="Customer Name" defaultValue={user?.displayName} className="input input-bordered" />
                    <input type="text" name="customerEmail" placeholder="Customer Email" defaultValue={user?.email} className="input input-bordered" />
                    </div>
                    <textarea name="customerAddress" placeholder="Customer Address" className="textarea textarea-bordered h-52"></textarea>
