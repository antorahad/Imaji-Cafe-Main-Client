const BookedOrderData = ({ item, handleRemove }) => {
    const { _id, image, orderName, orderPrice, orderQuantity, deliveryDate, name, address } = item;
    return (
        <tr>
            <td>
...
export default BookedOrderData;